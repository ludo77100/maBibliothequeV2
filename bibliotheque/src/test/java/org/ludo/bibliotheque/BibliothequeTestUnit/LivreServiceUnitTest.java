...
public class LivreServiceUnitTest {
    ...
    public void setUp(){
        ...
        exemplaire1.setEtat(EtatEnums.EMPRUNTE);
        exemplaire1.setIdentifiant("4Lid");
        exemplaire1.setIdExemplaire(4L);
        exemplaireSet1.add(exemplaire2);

        Exemplaire exemplaire3 = new Exemplaire();
        exemplaire1.setEtat(EtatEnums.DISPONIBLE);
        exemplaire1.setIdentifiant("5Lid");
        exemplaire1.setIdExemplaire(5L);
        exemplaireSet1.add(exemplaire3);

        Exemplaire exemplaire4 = new Exemplaire();
        exemplaire1.setEtat(EtatEnums.EMPRUNTE);
        exemplaire1.setIdentifiant("6Lid");
        exemplaire1.setIdExemplaire(6L);
