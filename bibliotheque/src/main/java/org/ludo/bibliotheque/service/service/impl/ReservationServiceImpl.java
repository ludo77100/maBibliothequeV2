...
public class ReservationServiceImpl implements ReservationService {
    ...
    public Reservation ouvrirReservation(String pseudoDemandeur, String titreLivre) {
        ...
        this.verifLivreReserveNonEmprunte(listeEmpruntUtilisateur, pseudoDemandeur);
     ...
     * @param titreLivre
     */
    public void verifLivreReserveNonEmprunte(List<Emprunt> listeEmpruntUtilisateur, String titreLivre){
